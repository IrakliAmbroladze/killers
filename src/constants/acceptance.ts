...
export const criteria_constants = [
  ...
  { id: "3.3", label: "მილები და საკანალიზაციო ჭები დაცულია მეტალის ბადით" },
  {
    id: "4.1",
    label:
      "ხეები, ბუჩქები, ნაფოტები, ნახერხი და სხვა ტიპის მცენარეები არის შენობიდან მოშორებით",
  },
  { id: "5.1", label: "შენობის გარშემო არ გროვდება ნაგავი" },
  { id: "5.2", label: "მოწესრიგებულია ბალახი და სხვა მცენარეები" },
  { id: "6.1", label: "კედლები და ჭერი არის სუფთა, არ არის ცხიმიანი" },
  { id: "6.2", label: "და არ იქმნება კონდესატი" },
  {
    id: "7.1",
  ...
  { id: "10.1", label: "ჭურჭლის სარეცხი სივრცე სუფთადაა" },
  { id: "10.2", label: "შენარჩუნებულია სიმშრალე" },
  { id: "10.3", label: "გასარეცხი ჭურჭელი არ გროვდება სამზარეულოში" },
  {
    id: "11.1",
    label: "ნარჩენების ოთახი მოწესრიგებულია, ნაგავი სწორად არის შეფუთული",
  },
  { id: "11.2", label: "კონტეინერები სუფთა მდგომარეობაშია" },
  {
    id: "12.1",
    label: "სასაწყობე სივრცეში პროდუქტი იატაკიდან და კედლებიდან მოშორებითაა",
  },
  { id: "12.2", label: "მუყაოს ყუთებში არ ინახება პროდუქცია" },
  {
    id: "13.1",
    label: "სასადილო ოთახში მაგიდები სუფთაა, საკვების ნარჩენებისგან თავისუფალი",
  },
  { id: "13.2", label: "ინვენტარი სუფთა მდგომარეობაში" },
  {
    id: "14.1",
    label: "სველი წერტილები სუფთა და მომშრალებულია, არ ჟონავს წყალი",
  },
  { id: "14.2", label: "ტრაპებში არ გროვდება ნაგავი" },
  {
    id: "15.1",
    label:
      "ოფისები და მსგავსი სივრცეები არის მოწესრიგებული, არ არის საკვების ნარჩენები",
  },
  { id: "16.1", label: "გასახდელები მოწესრიგებულია" },
  {
    id: "16.2",
