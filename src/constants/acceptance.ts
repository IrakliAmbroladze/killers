...
export const criteria_constants = [
  ...
  { id: "15.1", label: "კონტეინერები სუფთა მდგომარეობაშია" },
  ...
  { id: "18.1", label: "ინვენტარი სუფთა მდგომარეობაში" },
  {
    id: "18.2",
  ...
  { id: "20.1", label: "ტრაპებში არ გროვდება ნაგავი" },
  { id: "20.2", label: "გასახდელები მოწესრიგებულია" },
  {
    id: "21.1",
