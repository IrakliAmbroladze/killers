...
export const criteria_constants = [
  ...
  {
    id: "9.1",
    label: "საკვების მოსამზადებელი სივრცე მოწესრიგებულია, არ რჩება ნარჩენები",
  },
  {
    id: "10.1",
    label: "საკვები არ არის ხელმისაწვდომი მავნებლისთვის",
  },
  {
    id: "11.1",
    label:
  ...
  { id: "12.1", label: "ჭურჭლის სარეცხი სივრცე სუფთადაა" },
  { id: "12.2", label: "შენარჩუნებულია სიმშრალე" },
  { id: "13.1", label: "გასარეცხი ჭურჭელი არ გროვდება სამზარეულოში" },
  {
    id: "14.1",
    label: "ნარჩენების ოთახი მოწესრიგებულია, ნაგავი სწორად არის შეფუთული",
  },
  { id: "14.2", label: "კონტეინერები სუფთა მდგომარეობაშია" },
  {
    id: "15.1",
    label: "სასაწყობე სივრცეში პროდუქტი იატაკიდან და კედლებიდან მოშორებითაა",
  },
  { id: "15.2", label: "მუყაოს ყუთებში არ ინახება პროდუქცია" },
  {
    id: "16.1",
    label: "სასადილო ოთახში მაგიდები სუფთაა, საკვების ნარჩენებისგან თავისუფალი",
  },
  { id: "16.2", label: "ინვენტარი სუფთა მდგომარეობაში" },
  {
    id: "17.1",
    label: "სველი წერტილები სუფთა და მომშრალებულია, არ ჟონავს წყალი",
  },
  { id: "17.2", label: "ტრაპებში არ გროვდება ნაგავი" },
  {
    id: "18.1",
    label:
      "ოფისები და მსგავსი სივრცეები არის მოწესრიგებული, არ არის საკვების ნარჩენები",
  },
  { id: "19.1", label: "გასახდელები მოწესრიგებულია" },
  {
    id: "19.2",
