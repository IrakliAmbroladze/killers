...
export const inspectionOther = [
  ...
  "მუყაოს ყუთებში არ ინახება პროდუქცია",
  "სასადილო ოთახში მაგიდები სუფთაა, საკვების ნარჩენებისგან თავისუფალი",
  "ინვენტარი სუფთა მდგომარეობაში",
  "სველი წერტილები სუფთა და მომშრალებულია, არ ჟონავს წყალი",
  "ტრაპებში არ გროვდება ნაგავი",
  "ოფისები და მსგავსი სივრცეები არის მოწესრიგებული, არ არის საკვების ნარჩენები",
  "გასახდელები მოწესრიგებულია",
